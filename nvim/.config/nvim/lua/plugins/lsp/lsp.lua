...
vim.api.nvim_create_autocmd('LspAttach', {
  callback = function(ev)
    ...
    buf_map({ 'n', 'x' }, '<leader>ca', vim.lsp.buf.code_action, 'Code action')
    ...
    buf_map('i', '<C-Space>', function()
      vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('<C-x><C-o>', false, false, true), 'n', false)
    end, 'LSP omnifunc completion')
